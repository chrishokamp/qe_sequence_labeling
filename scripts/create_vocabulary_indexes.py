"""
Create source, target, and tag vocabularies
"""

# WORKING: our datasets are small, so it might make sense to just modify vocabularies learned on bigger data
# WORKING: source and target vocabs can stay the same, just map the target vocab 2x into a new index which contains OK- and BAD- for every token
