...
do
    ...
    do
        ...
        paste ${DIR}/${PREFIX}.en.factors.bpe /dev/null ${DIR}/${PREFIX}.de.factors.bpe | sed "s/\t\t/ ${CONCAT_FACTOR} /g" > ${DIR}/${PREFIX}.src-mt.concatenated.factors.bpe
        echo "Wrote: ${DIR}/${PREFIX}.src-mt.concatenated.factors.bpe"
    done
done
